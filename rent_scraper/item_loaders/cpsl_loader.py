...
def format_price(price_text):
    """Take text representing a price on the Clifton Property Services website and return an integer."""
    return int(re.sub(r"\D", "", price_text.split(" ")[0]))


class CliftonPropertyServicesPropertyLoader(ItemLoader):
