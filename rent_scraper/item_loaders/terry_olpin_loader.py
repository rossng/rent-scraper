...
from rent_scraper.processors.terry_olpin_processors import TerryOlpinPriceProcessor
...
class TerryOlpinPropertyLoader(ItemLoader):
    ...
    price_per_month_in = TerryOlpinPriceProcessor()
